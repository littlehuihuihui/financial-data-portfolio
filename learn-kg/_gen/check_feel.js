  ...
  "children": [
    ...
    (function spawnParticles() {
      ...
      for (let i = 0; i < 40; i++) {
        ...
        s.style.opacity = String(0.18 + Math.random() * 0.55);
    ...
    let kgHoverId = null;
        ...
        /** 弹簧 + 软持续物理（对齐百科 BarnesHut 稳定后不关死） */
