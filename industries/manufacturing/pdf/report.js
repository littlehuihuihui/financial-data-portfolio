...
(function () {
  ...
  function renderToolboxPdf() {
    ...
    const opening =
      `<p class="toolbox-opening-pdf">分析方法工具箱是前五层分析的补充，按<strong>质量 / 设备与产能 / 成本与供应链</strong>三类组织，共 <strong>${total} 种</strong>制造业可复用方法。每种方法含人话解释、业务问题与作品集应用示例；交互图表示例见 <code>../pages/methodology.html</code>。</p>`;
          ...
          .map(
            (m) =>
              `<div class="pdf-toolbox-item">
                ...
                <p>解释：${esc(m.explain || m.what || "")}</p>
                <p>业务问题：${esc(m.businessQuestion || "—")}</p>
                <p>作品集：${esc(m.portfolio || "—")}</p>
              </div>`
          )
          .join("");
