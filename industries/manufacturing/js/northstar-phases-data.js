  ...
  phases: [
    {
      ...
      focus_dashboards: "交付分析 · 生产总览 · 供应链",
      primary_dashboard: "delivery",
      focus_ids: ["delivery", "production", "supply"],
    },
    {
      id: "p2",
      name: "质量爬坡",
      ...
      northstar: {
        ...
        value_display: "96.8",
        unit: "%",
        aliases: ["FPY", "良品率", "一次通过率"],
      },
      guardrails: ["来料 PPM", "单位成本", "客诉批次"],
      focus_dashboards: "质量分析 · 缺陷柏拉图 · 供应商质量",
      primary_dashboard: "quality",
      focus_ids: ["quality", "scrap-rework", "supplier-score"],
    },
    {
      id: "p3",
      name: "设备效率",
      ...
      guardrails: ["良品率", "单位成本", "计划外停机时长"],
      focus_dashboards: "设备 OEE · 生产总览 · 人工效率",
      primary_dashboard: "equipment",
      focus_ids: ["equipment", "production", "labor", "downtime"],
    },
    {
      id: "p4",
      name: "综合卓越",
      ...
      guardrails: ["良品率", "单位成本", "来料 PPM"],
      focus_dashboards: "生产总览（CMEI）· 质量 · 设备 · 成本",
      primary_dashboard: "production",
      focus_ids: ["production", "quality", "equipment", "cost"],
    },
  ],
};
